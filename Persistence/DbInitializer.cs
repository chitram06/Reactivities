...
{    
    ...
    {
        //If the Activities table is not empty, return
        if(context.Activities.Any()) return;

        //else - these are the initial set of data that will be populated when the application runs
        ...
        //EF is tracking the activites in-memory
